...
set title "Расчётные кривые времени поиска по AVL, Декартово и Красно-чёрное деревьям (рандомные данные)"
...
plot "plots/dat-files/search_random.dat" using 1:2 title "AVL" with linespoint, \
     ...
     "plots/dat-files/search_random.dat" using 1:4 title "RB" with linespoint
