...
set title "Расчётные кривые времени поиска по AVL, Декартово и Красно-Чёрное деревьям (сортированные данные)"
...
plot "plots/dat-files/search_sorted.dat" using 1:2 title "AVL" with linespoint, \
     ...
     "plots/dat-files/search_sorted.dat" using 1:4 title "RB" with linespoint
