...
set title "Расчётные кривые времени удаления в AVL, Декартово и Красно-чёрное деревьях (сортированные данные)"
...
plot "plots/dat-files/delete_sorted.dat" using 1:2 title "AVL" with linespoint, \
     ...
     "plots/dat-files/delete_sorted.dat" using 1:4 title "RB" with linespoint
