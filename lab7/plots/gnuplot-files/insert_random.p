...
set title "Расчётные кривые времени вставки в AVL, Декартово и Красно-чёрное деревья (рандомные значения)"
...
plot "plots/dat-files/insert_random.dat" using 1:2 title "AVL" with linespoint, \
     ...
     "plots/dat-files/insert_random.dat" using 1:4 title "RB" with linespoint
